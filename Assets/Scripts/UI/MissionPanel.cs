...
namespace GameIdle
{
    ...
    public class MissionPanel : MonoBehaviour
    {
        ...
        private MissionRow BuildRow(int index, Vector2 aMin, Vector2 aMax, TMP_FontAsset font)
        {
            ...
            row.nameText.text = mission.name; row.nameText.fontSize = 13; row.nameText.fontStyle = FontStyles.Bold;
            ...
            row.progressText.fontSize = 11; row.progressText.color = new Color(0.7f, 0.8f, 1f);
            ...
            row.claimBtnText.fontSize = 12; row.claimBtnText.fontStyle = FontStyles.Bold;
